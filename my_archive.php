...
<body class="light-theme || dark-theme">
	...
	<main>
		<div id = "container_search"> <br><br><br><h2> Twoje zakończone ogłoszenia </h2> <br><br><br></div>
		...
		<div id = "bok_prawy" style=" min-height: 556px;">
						...
						<section class = "offers">
							<?php 
							$sql = "SELECT * FROM archive WHERE owner_id = '".$_SESSION['userid']."'";
							
							$result = mysqli_query($conn, $sql);
							$number_of_results = mysqli_num_rows($result);

							if ($number_of_results === 0) {
								echo "<br><br><br><br><br><h2>Nie posiadałeś jeszcze żadnego ogłoszenia.</h2>";
							}
							...
							while($row = mysqli_fetch_array($result_tender)) {
								...
								<aside class = "artykul_cena" style="color:black; text-align: right;"><?php echo $end_prices[$tender_id] > 0? $end_prices[$tender_id] . " zł" : "brak ofert"; ?><br><br>
									</aside>
							</article> <br>
