...
<body class="light-theme || dark-theme">
	...
	<main>
		<div id = "container_search"> <br><br><br><h2> Twoje trwające ogłoszenia </h2> <br><br><br></div>
		...
		<div id = "bok_prawy" style=" min-height: 556px;">
						...
						<section class = "offers">
							<?php 
							$sql = "SELECT * FROM tenders WHERE owner_id = '".$_SESSION['userid']."'";
							
							$result = mysqli_query($conn, $sql);
							$number_of_results = mysqli_num_rows($result);

							if ($number_of_results === 0) {
								echo "<br><br><br><br><br><h2>Nie posiadasz żadnych ogłoszeń.</h2>";
							}
							...
							$sql_tender = "SELECT * FROM tenders WHERE tender_id = $tender_id;";
							...
							echo '<a href="owned.php?view=' . $_GET['view'] . '&page=' . $page . '&k=' . $k .'&ctgr=' . $ctgr .'&subctgr=' . $subctgr .'&voivodeship=' . $voivodeship .'&city=' . $city .'&user=' . $user .'&cond=' . $cond .'&f_od=' . $f_od .'&f_do=' . $f_do .'&order=' . $order .'">' . $page . " " .'</a>'; } ?> </p> <?php } ?>
