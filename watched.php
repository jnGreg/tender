...
<body class="light-theme || dark-theme">
	...
	<main>
		<div id = "container_search"> <br><br><br><h2> Obserwowane ogłoszenia </h2> <br><br><br></div>
		...
		<div id = "bok_prawy" style=" min-height: 556px;">
						...
						<section class = "offers">
							...
							if ($number_of_results === 0) {
								echo "<br><br><br><br><br><h2>Nie obserwujesz żadnych ogłoszeń.</h2>";
							}
							...
							while($row = mysqli_fetch_array($result)) {
								$watched_id = $row['tender_id'];
							
							$sql_tender = "SELECT * FROM tenders WHERE tender_id = $watched_id;";
							...
							echo '<a href="watched.php?view=' . $_GET['view'] . '&page=' . $page . '&k=' . $k .'&ctgr=' . $ctgr .'&subctgr=' . $subctgr .'&voivodeship=' . $voivodeship .'&city=' . $city .'&user=' . $user .'&cond=' . $cond .'&f_od=' . $f_od .'&f_do=' . $f_do .'&order=' . $order .'">' . $page . " " .'</a>'; } ?> </p> <?php } ?>
